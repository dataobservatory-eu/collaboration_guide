...
Marking up a reference to [@retroharmonize] with `[@R-retroharmonize]` will place the citation in your selected format (here APA) to the text, and to the [references](#references) at the end of this documentation.
